...
const SectionCard = ({bg, text, imagePath}: SectionCardProps) => {
  return <Box bg={bg} width="50%" height="350px" display="flex" justifyContent={"center"} alignItems={"center"} fontSize={40}>
    {text}
  </Box>
}
const Projects = () => {
  return (<>
     <NavBar />
      <Box width="100%" display="flex" alignItems="center" justifyContent="center">
        <Image boxSize="80%" borderRadius="20" margin={20} src='/heroMainProject.png' />
      </Box>
      <Box fontWeight={200} backgroundColor={'greenyellow'}  width="100%" padding={20} paddingLeft={20}>
        <Text>Some people call this Jack-of-all-trade. I call this a Renaissance woman in the making. </Text>
        <Text> Having interested in many things, I yada yada yada </Text>
